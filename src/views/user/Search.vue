  ...
  <div>
    ...
    <div class="container-fluid ">
      ...
      <div v-if="searching" class="searching">
        <img alt="" src="@/assets/images/searching.gif"/>

        <h3>Searching...</h3>
      </div>
      <SearchProducts
          v-else-if="!searching && productsView"
    ...
    <BottomNav :active="'search'" :cartShow="showCart" :nav-links="navLinks" @toggleCartModal="toggleCartModal"/>
    <!-- Single Cart Item Modal-->
