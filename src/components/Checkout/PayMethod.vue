          ...
          <div class="form-container">
            ...
            >
              <b-form-radio
                ...
                class="mb-3"
                v-if="user.last4"
              >Pay with **** {{user.last4}}</b-form-radio>
              <b-form-radio
                v-model="choice"
                name="some-radios"
                value="2"
                v-if="user.last4"
              >Pay with new card</b-form-radio>
              <div class="m-2">
                <div id="card-error">
                  <b-alert
                ...
                <div class="card-info" :class="{'disabled': choice == 1 && user.last4}">
                  <label class="cardinfo-label" for="card-number">Card Number</label>
                  <div id="card-number" class='input-wrapper'></div>
                  <div class="cardinfo-wrapper">
                    <div class="cardinfo-exp-date">
                      <label class="cardinfo-label" for="card-expiry">Card Expiry</label>
                      <div id="card-expiry" class='input-wrapper'></div>
                    </div>
                    <div class="cardinfo-cvv">
                      <label class="cardinfo-label" for="card-cvc">Card CVC</label>
                      <div id="card-cvc" class='input-wrapper'></div>
                    </div>
                  </div>
                </div>
              </div>
            </b-form-group>
            <div id="button-pay" @click="createToken">Continue</div>
          </div>
        </div>
      </div>
    </b-container>
...
export default {
  ...
  methods: {
    ...
    async createToken () {
      if (this.choice == 2 || !this.user.last4) {
        ...
        this.$emit('updateToken', {choice: 2, id, cardID})
      } else {
        this.$emit('updateToken', {choice: 1})
      }
      this.closeMe()
    },
